...
domain = Domain(256, 256; Lx=50, Ly=50, MemoryType=ROCArray, precision=Float32)
...
# The output
output_file_name = joinpath("/scratch/project_465002229/HW/paper-1", "Garcia_2005_PoP.h5")
